...
def startgame(event):
    ...
    if(score>=0 and score<3):
        wordlabel.configure(text=letters[0])
        levellabel=Label(game.root,text='level 1',font=('airal',15,'italic bold'),bg='black',fg='white')
        levellabel.place(x=15,y=200)
...
def game():
    ...
    global TimeLeft,score,miss,timelabelcount,gameplaylabel,wordlabel,wordentry,scorelabelcount,levellabel
    score=0
    TimeLeft=60
    miss=0
    ...
    if(startgame.score>=0 and startgame.score<3):
        levellabel=Label(root,text='level 1',font=('airal',15,'italic bold'),bg='black',fg='white')
        levellabel.place(x=15,y=200)
    elif(score>=3 and score<6):
        levellabel=Label(root,text='level 2',font=('airal',15,'italic bold'),bg='black',fg='white')
        levellabel.place(x=15,y=200)
